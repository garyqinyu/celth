...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
ScreenMenuClass::ScreenMenuClass(SIGNED iLeft, SIGNED iTop) : 
...
/*
    ...
    pPictureMenuWindowTitle = new PegPrompt(ChildRect, LS(SID_ScreenMenuWindowTitle), PictureWindowTitleID, FF_NONE|AF_TRANSPARENT|TJ_CENTER);
    ...
    /* WB End Construction */
		Id(PICTURE_MENU_ID);
	       ...
	       pContrastButton->SetFont(&Pronto_16);
	       pBrightnessButton->SetFont(&Pronto_16);
#if 0
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
SIGNED ScreenMenuClass::Message(const PegMessage &Mesg)
{
...
/*---------------------------------------------------*/
void ScreenMenuClass::DisplayChildWindow(int WindowID)
{
...
void ScreenMenuClass::RefreshPictureWindow(void)
{
}
