...
extern PegBitmap gbBlueNeedleBitmap;
extern PegBitmap gbFordNeedleBitmap;
    ...
    PegDecoratedWindow(Rect)
{
    ...
    mpScale1 = new PegLinearBitmapScale(50, 50, 0, 100, 120, 23, &gbbluebkgBitmap,
                                        &gbBlueNeedleBitmap,
                                        SS_FACELEFT | SS_BOTTOMTOTOP | 
                                        SS_ORIENTVERT);
    ...
    mpScale3 = new PegLinearBitmapScale(135, 50, 0, 100, 167, 15, &gbforddbBitmap,
                                        &gbFordNeedleBitmap);
    mpScale3->Style(mpScale3->Style() & ~SS_POLYNEEDLE);
    //mpScale3->Style(mpScale3->Style() | SS_THICKNEEDLE);
    mpScale3->SetNeedleOffset(-10);

    WinRect.Set(215, 50, 414, 89);
