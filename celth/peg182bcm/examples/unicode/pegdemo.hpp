...
#define ID_MAIN_DIALOG  501
#define ID_LANGUAGE_BUTTON 502


enum AppMessage {
    FLOATING_CHILD_CLOSED = FIRST_USER_MESSAGE,
    TWIN_CLOSED,
    UM_LANGUAGE_CHANGE
};
...
{
    public:
        MainDemoDialog(const PegRect &Rect, const PEGCHAR *Title);
...
{
    public:
        ButtonDialog(PegRect &Rect, const PEGCHAR *Title);
        SIGNED Message(const PegMessage &Mesg);
...
{
    public:
        MainAppWindow(PegRect Rect, const PEGCHAR *Title, BOOL bFirst = TRUE);
...
class DemoListWindow : public PegDecoratedWindow
{
    public:
        ...
        DemoListWindow(PegRect Rect, const PEGCHAR *Title);
        SIGNED Message(const PegMessage &Mesg);
...
{
    public:
        DemoSliderWindow(PegRect Rect, const PEGCHAR *Title);
        SIGNED Message(const PegMessage &Mesg);
...
{
    public:
        StringWindow(PegRect Rect, const PEGCHAR *Title);
        SIGNED Message(const PegMessage &Mesg);
...
{
    public:
        ProgBarWindow(PegRect Rect, const PEGCHAR *Title);
        SIGNED Message(const PegMessage &Mesg);
...
/*--------------------------------------------------------------------------*/
class SwapLanguageButton : public PegTextButton
{
    public:
        SwapLanguageButton(PegRect &Size);
        SIGNED Message(const PegMessage &Mesg);
};
