...
class DialWindow : public PegDecoratedWindow
{
    ...
    private:
        PegCircularDial* mpDial1;
        PegCircularDial* mpDial2;
		PegCircularDial* mpDial3;
...
{
    Add(new PegTitle("PegCircularDial Example"));
    ...
    //mpDial2 = new PegCircularDial(210, 50, 225, 315, 0, 300, FF_RAISED);
	...
	WinRect.Shift(160, 0);
    //mpDial3 = new PegCircularDial(WinRect, 225, 315, 0, 300, FF_RECESSED);
    //mpDial3 = new PegCircularDial(370, 50, 225, 315, 0, 300, FF_RECESSED);
    ...
    case PM_TIMER:
        {
            ...
            else if(miDial3Val > 720)
            {
                miDial3Dir = -1;
            }
            miDial3Val += miDial3Dir;
