...
{
    public:
        PegString(const PegRect &Rect, const PEGCHAR *Text = NULL,
        ...
        PegString(SIGNED iLeft, SIGNED iTop, const PEGCHAR *Text = NULL,
            WORD wId = 0, WORD wStyle = FF_RECESSED|AF_ENABLED|EF_EDIT,
            SIGNED iLen = -1);
        ...
        virtual void SetMark(PEGCHAR *MarkStart, PEGCHAR *MarkEnd);
