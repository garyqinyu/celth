/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
// sc400_1.hpp - Linear screen driver for 1-bpp (monochrome) operation on the
//      SC400 CPU with internal CGA controller.
//
...
#ifndef _SC400MONOSCREEN_
#define _SC400MONOSCREEN_
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
class Sc400MonoScreen : public PegScreen
{
    public:
        
        Sc400MonoScreen(PegRect &);

        virtual ~Sc400MonoScreen();
