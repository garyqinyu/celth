/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
// 1356scrn.hpp - PegScreen screen driver for Seiko-Epson 1356 video
...
#ifndef _SED1356SCRN_
#define _SED1356SCRN_
...
class SED1356Screen : public PegScreen
{
    public:
        ...
        // These variables are used only for running the SDU1356 eval card
