/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
// CT545_4 - Linear screen driver for 4-bpp (16 color) operation on C&T
//   65545 video controller.
//
...
#define VID_MEM_SIZE (64*1024) // size of video memory required
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
class CTLinear4Screen : public PegScreen
{
    public:
       #ifndef PEGWIN32
        CTLinear4Screen(PegRect &);
       #else
        CTLinear4Screen(HWND hwnd, PegRect &);
        SIGNED mwWinRectXOffset;
        SIGNED mwWinRectYOffset;
       #endif

        virtual ~CTLinear4Screen();
