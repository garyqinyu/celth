/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
// lh77mono.hpp - Linear screen driver for 1-bpp (monochrome) operation on 
// the Sharp/ARM LH77790 and derivitives.
//
...
#define LCD_MAX_BYTES_LINE	 0x27    /* 320 pixels/8bits=40 bytes (0-39) */
#define LCD_CLK_ENABLE 	  0x40
#define LCD_CP1W_VALUE    0x50       /* yields 12.88 ms frame period */
#define LCD_MODE_DSPL_GRAY_ON  0x8B 
#define LCD_MODE_DSPL_MONO_ON  0x83 
#define LCD_VERT_LINES_LSB	 0xEF	 /* max vertical line=239 (0-239=240) */
#define LCD_VERT_LINES_MSB	 0x00	 /* MSB is zero */

#define LCD_FRAME_BUFFER_SIZE (320 * 240 / 8)
