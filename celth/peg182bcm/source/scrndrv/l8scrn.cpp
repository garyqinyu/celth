...
PegScreen *CreatePegScreen(void)
{
    ...
    PegScreen *pScreen = new L8Screen(Rect);
    return pScreen;
}
#else
PegScreen *CreateWinScreen(HWND hwnd)
{
    ...
    return (new L8Screen(hwnd, rSize));
}
#endif
...
/*--------------------------------------------------------------------------*/
void L8Screen::BeginDraw(PegThing *)
{
    LOCK_PEG
    if (!mwDrawNesting)
    {
...
/*--------------------------------------------------------------------------*/
void L8Screen::BeginDraw(PegThing *Caller, PegBitmap *pMap)
{
    if (mbVirtualDraw)
    {
        return;
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::EndDraw(PegBitmap *pMap)
{
    if (mbVirtualDraw)
    {
        mbVirtualDraw = FALSE;
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::LineView(SIGNED wXStart, SIGNED wYStart, SIGNED wXEnd, 
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::HorizontalLine(SIGNED wXStart, SIGNED wXEnd, SIGNED wYPos,
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::VerticalLine(SIGNED wYStart, SIGNED wYEnd, SIGNED wXPos,
    COLORVAL Color, SIGNED wWidth)
{
    while(wYStart <= wYEnd)
    {
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::HorizontalLineXOR(SIGNED wXStart, SIGNED wXEnd, SIGNED wYPos)
{
    UCHAR *Put = mpScanPointers[wYPos] + wXStart;
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::VerticalLineXOR(SIGNED wYStart, SIGNED wYEnd, SIGNED wXPos)
{
    UCHAR uVal;
...
/*--------------------------------------------------------------------------*/
void L8Screen::Capture(PegCapture *Info, PegRect &CaptureRect)
{
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::BitmapView(const PegPoint Where, const PegBitmap *Getmap,
    const PegRect &View)
{
    if (IS_RLE(Getmap))
    {
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::DrawRleBitmap(const PegPoint Where, const PegRect View,
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::RectMoveView(PegThing *Caller, const PegRect &View,
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::DrawTextView(PegPoint Where, const PEGCHAR *Text, PegColor &Color,
...
void L8Screen::DrawOutlineText(PegPoint Where, const PEGCHAR *Text, PegColor &Color,
    PegFont *Font, SIGNED iCount, PegRect &Rect)
{
    UCHAR PEGFAR *pCurrentChar = (UCHAR PEGFAR *) Text;
    UCHAR PEGFAR *pGetData;
...
/*--------------------------------------------------------------------------*/
void L8Screen::HidePointer(void)
{
#ifndef PEGWIN32
...
/*--------------------------------------------------------------------------*/
void L8Screen::SetPointer(PegPoint Where)
{
#ifndef PEGWIN32
...
/*--------------------------------------------------------------------------*/
void L8Screen::SetPointerType(UCHAR bType)
{
   #ifdef PEGWIN32
...
/*--------------------------------------------------------------------------*/
void L8Screen::ResetPalette(void)
{
    SetPalette(0, 232, DefPalette256);
}
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
UCHAR *L8Screen::GetPalette(DWORD *pPutSize)
{
    *pPutSize = 232;
    return muPalette;
}
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::SetPalette(SIGNED iFirst, SIGNED iCount, const UCHAR *pGet)
{
   #ifdef PEGWIN32
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void L8Screen::ConfigureController(void)
{
    #ifdef PEGWIN32
    #else
...
void L8Screen::MemoryToScreen(void)
{
    if (!miInvalidCount)
    {
        return;
