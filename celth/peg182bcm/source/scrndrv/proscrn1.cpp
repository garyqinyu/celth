...
/*--------------------------------------------------------------------------*/
PegBitmap *ProMonoScreen::CreateBitmap(SIGNED wWidth, SIGNED wHeight, BOOL bHasTrans)
{
   PegBitmap *pMap = NULL;
...
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
void ProMonoScreen::DrawTextView(PegPoint Where, const PEGCHAR *Text, PegColor &Color,
...
void ProMonoScreen::MemoryToScreen(void)
{
    ...
    StretchDIBits(mHdc, 0, 0, 239, 319,
        0, 0, 239, 319,
